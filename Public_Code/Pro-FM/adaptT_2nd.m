function [T1,T2] = adaptT_2nd(I,Capacity,metricEC,metricED)
...
%-----------C++ implementation
[F,NL3,ec1,ed1_Plus,Exx2,Eyy2,pairnum] = hisGen(E,NL,NL2,index,max(NL),metricEC,metricED);
